    ...
    <>
  ...
  
        {
          doesContain(movieObj) ? (
            ...
            <div 
          onClick={() => addtoWatchlist(movieObj)} className='justify-center 	padding-bottom: 10rem'>
            😊
          </div>
          )
        }
        <div className='text-white w-full text-center text-0.5 p-0.5 bg-gray-900/70 rouded-lg'>{movieObj.title}</div>
      </div>
    </>
  )
}
